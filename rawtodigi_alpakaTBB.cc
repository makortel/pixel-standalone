...
namespace alpaka {
  ...
  void rawtodigi(const Input *input_d, Output *output_d, 
                ...
                bool useQualityInfo, bool includeErrors, bool debug,CpuParallelTBB<1u>::QueueSync queue) {
    
    using CpuParallelTBB = CpuParallelTBB<1u>;
    using Vec = CpuParallelTBB::Vec;
    ...
    using WorkDiv = CpuParallelTBB::WorkDiv;
    ...
    rawtodigi_kernel<CpuParallelTBB::Idx> kernel;

    auto const taskRawToDigiKernel(alpaka::kernel::createTaskKernel<CpuParallelTBB::Acc>(
                                  workDiv,
                                  kernel,
                                  input_d,
                                  output_d,
